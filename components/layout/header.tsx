      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        {isAdmin && (
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-3 md:px-4 h-9 md:h-10 text-white font-semibold text-xs md:text-sm shadow-sm hover:bg-[#1ebe5d] transition-colors flex-shrink-0"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 flex-shrink-0 hidden md:block" aria-hidden="true">
            ...
            <span className="whitespace-nowrap">Configurá tu WhatsApp</span>
          </Link>
        )}
